...
define_hls_module SobelFilter2 ../SobelFilter2.cpp
define_hls_config SobelFilter2 BASIC
define_hls_config SobelFilter2 DPA       --dpopt_auto=op,expr
...
define_sim_config V_BASIC "SobelFilter RTL_V BASIC" "SobelFilter2 RTL_V BASIC" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
### 5.3 The Verilog simulation for HLS config "DPA". 
define_sim_config V_DPA "SobelFilter RTL_V DPA" "SobelFilter2 RTL_V DPA" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
